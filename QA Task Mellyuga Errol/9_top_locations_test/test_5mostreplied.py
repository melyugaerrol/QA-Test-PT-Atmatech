...
class Test5mostreplied():
  ...
  def test_5mostreplied(self):
    ...
    # 6 | click | css=.section:nth-child(8) .list-group-item:nth-child(6) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(8) .list-group-item:nth-child(6) .text-truncate").click()
    ...
    # 8 | select | css=div:nth-child(2) > div > .d-flex > .custom-select | label=Most Replied
    ...
    # 9 | mouseOver | css=.p-2 | 
    element = self.driver.find_element(By.CSS_SELECTOR, ".p-2")
