...
class Test4mostliked():
  ...
  def test_4mostliked(self):
    ...
    # 5 | runScript | window.scrollTo(0,1411) | 
    self.driver.execute_script("window.scrollTo(0,1411)")
    # 6 | click | css=.section:nth-child(8) .list-group-item:nth-child(5) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(8) .list-group-item:nth-child(5) .text-truncate").click()
    ...
    # 9 | mouseOver | id=__BVID__980__BV_toggle_ | 
    element = self.driver.find_element(By.ID, "__BVID__980__BV_toggle_")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    # 10 | mouseOut | id=__BVID__980__BV_toggle_ | 
