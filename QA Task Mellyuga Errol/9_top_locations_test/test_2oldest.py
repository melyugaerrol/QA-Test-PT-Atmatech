...
class Test2oldest():
  ...
  def test_2oldest(self):
    ...
    # 5 | runScript | window.scrollTo(0,1236) | 
    self.driver.execute_script("window.scrollTo(0,1236)")
    # 6 | click | css=.section:nth-child(8) .list-group-item:nth-child(2) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(8) .list-group-item:nth-child(2) .text-truncate").click()
