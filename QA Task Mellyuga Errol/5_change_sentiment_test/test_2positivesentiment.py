...
class Test8positivesentiment():
  ...
  def test_8positivesentiment(self):
    # Test name: 8_positive_sentiment
    ...
    # 6 | select | id=__BVID__74 | label=Positive
    dropdown = self.driver.find_element(By.ID, "__BVID__74")
    dropdown.find_element(By.XPATH, "//option[. = 'Positive']").click()
    # 7 | runScript | window.scrollTo(0,0) | 
    self.driver.execute_script("window.scrollTo(0,0)")
    # 8 | runScript | window.scrollTo(0,1228) | 
    self.driver.execute_script("window.scrollTo(0,1228)")
    # 9 | runScript | window.scrollTo(0,1464) | 
    self.driver.execute_script("window.scrollTo(0,1464)")
    # 10 | close |  | 
    self.driver.close()
