...
class Test7hideentity():
  ...
  def test_7hideentity(self):
    ...
    # 6 | click | css=.section:nth-child(4) | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(4)").click()
    # 7 | click | css=.section:nth-child(4) .list-group-item:nth-child(3) .btn | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(4) .list-group-item:nth-child(3) .btn").click()
