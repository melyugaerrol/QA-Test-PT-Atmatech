...
class Test5mostreplied():
  ...
  def test_5mostreplied(self):
    ...
    # 5 | runScript | window.scrollTo(0,1290) | 
    self.driver.execute_script("window.scrollTo(0,1290)")
    # 6 | click | css=.section:nth-child(5) .list-group-item:nth-child(8) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(5) .list-group-item:nth-child(8) .text-truncate").click()
