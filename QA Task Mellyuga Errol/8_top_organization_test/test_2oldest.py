...
class Test2oldest():
  ...
  def test_2oldest(self):
    ...
    # 4 | runScript | window.scrollTo(0,339) | 
    self.driver.execute_script("window.scrollTo(0,339)")
    # 5 | click | css=.section:nth-child(5) .list-group-item:nth-child(3) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(5) .list-group-item:nth-child(3) .text-truncate").click()
    # 6 | click | css=div:nth-child(2) > div > .d-flex > .custom-select | 
    self.driver.find_element(By.CSS_SELECTOR, "div:nth-child(2) > div > .d-flex > .custom-select").click()
    # 7 | select | css=div:nth-child(2) > div > .d-flex > .custom-select | label=Oldest
