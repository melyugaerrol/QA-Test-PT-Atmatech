...
class Test4mostliked():
  ...
  def test_4mostliked(self):
    ...
    # 4 | runScript | window.scrollTo(0,1260) | 
    self.driver.execute_script("window.scrollTo(0,1260)")
    # 5 | click | css=.section:nth-child(5) .list-group-item:nth-child(6) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(5) .list-group-item:nth-child(6) .text-truncate").click()
    ...
    # 7 | select | css=div:nth-child(2) > div > .d-flex > .custom-select | label=Most Liked
