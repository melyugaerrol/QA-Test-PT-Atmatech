...
class Test1recent():
  ...
  def test_1recent(self):
    ...
    # 5 | runScript | window.scrollTo(0,1228) | 
    self.driver.execute_script("window.scrollTo(0,1228)")
    # 6 | click | css=.section:nth-child(5) .list-group-item:nth-child(1) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(5) .list-group-item:nth-child(1) .text-truncate").click()
