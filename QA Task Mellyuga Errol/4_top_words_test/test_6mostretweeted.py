...
class Test6mostretweeted():
  ...
  def test_6mostretweeted(self):
    ...
    # 5 | runScript | window.scrollTo(0,1261) | 
    self.driver.execute_script("window.scrollTo(0,1261)")
    # 6 | runScript | window.scrollTo(0,1700) | 
    self.driver.execute_script("window.scrollTo(0,1700)")
    # 7 | click | css=.cloud-item:nth-child(1) > span | 
    self.driver.find_element(By.CSS_SELECTOR, ".cloud-item:nth-child(1) > span").click()
    ...
    # 9 | select | css=div:nth-child(2) > div > .d-flex > .custom-select | label=Most Retweeted
