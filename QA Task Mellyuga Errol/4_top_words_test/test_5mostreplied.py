...
class Test5mostreplied():
  ...
  def test_5mostreplied(self):
    ...
    # 4 | runScript | window.scrollTo(0,1276) | 
    self.driver.execute_script("window.scrollTo(0,1276)")
    # 5 | runScript | window.scrollTo(0,1700) | 
    self.driver.execute_script("window.scrollTo(0,1700)")
    # 6 | click | linkText=tolol | 
    self.driver.find_element(By.LINK_TEXT, "tolol").click()
