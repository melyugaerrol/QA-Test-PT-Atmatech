...
class Test2oldest():
  ...
  def test_2oldest(self):
    ...
    # 5 | runScript | window.scrollTo(0,1235) | 
    self.driver.execute_script("window.scrollTo(0,1235)")
    # 6 | click | css=.cloud-item:nth-child(24) > span | 
    self.driver.find_element(By.CSS_SELECTOR, ".cloud-item:nth-child(24) > span").click()
