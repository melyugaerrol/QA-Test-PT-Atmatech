...
class Test3popular():
  ...
  def test_3popular(self):
    ...
    # 5 | runScript | window.scrollTo(0,1224) | 
    self.driver.execute_script("window.scrollTo(0,1224)")
    # 6 | runScript | window.scrollTo(0,1499) | 
    self.driver.execute_script("window.scrollTo(0,1499)")
    # 7 | click | css=.cloud-item:nth-child(32) > span | 
    self.driver.find_element(By.CSS_SELECTOR, ".cloud-item:nth-child(32) > span").click()
