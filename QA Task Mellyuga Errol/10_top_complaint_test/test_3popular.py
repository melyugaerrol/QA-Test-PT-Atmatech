...
class Test3popular():
  ...
  def test_3popular(self):
    ...
    # 5 | runScript | window.scrollTo(0,1265) | 
    self.driver.execute_script("window.scrollTo(0,1265)")
    # 6 | click | css=.section:nth-child(7) .list-group-item:nth-child(4) .text-truncate | 
    self.driver.find_element(By.CSS_SELECTOR, ".section:nth-child(7) .list-group-item:nth-child(4) .text-truncate").click()
